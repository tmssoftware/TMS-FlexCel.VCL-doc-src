---
uid: TTableApplyBorders
description: TTableApplyBorders
---
...
<pre><code class="lang-delphi hljs">TTableApplyBorders = record;</code></pre>

## Methods

|Name|Description|
|---|---|
|[Create](Create.md)|**Overloaded<br />**  [Create\(Boolean\)](Create.md#ttableapplyborderscreateboolean)<br />  [Create\(Boolean, Boolean, Boolean, Boolean, Boolean, Boolean\)](Create.md#ttableapplyborderscreateboolean-boolean-boolean-boolean-boolean-boolean)<br />|
