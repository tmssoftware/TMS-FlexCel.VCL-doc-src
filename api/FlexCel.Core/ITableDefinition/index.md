...
|[ColumnInGridFromId](ColumnInGridFromId.md)|Returns the position in the Excel grid for a column id\. So, for example, if the table starts at column 10 in Excel, and aId is the second column of the table, this method will return 11\. If the id doesn't exist, this method will return \-1\.<br />|
