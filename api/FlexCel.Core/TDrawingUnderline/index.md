---
uid: TDrawingUnderline
description: TDrawingUnderline
---
...
<pre><code class="lang-delphi hljs">TDrawingUnderline = record;</code></pre>
...
|[Implicit Conversion](op_Implicit.md)|Automatically converts from TNull instances to TDrawingUnderline instances|
