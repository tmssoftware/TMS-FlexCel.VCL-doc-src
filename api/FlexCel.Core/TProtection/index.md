...
|[EncryptionType](EncryptionType.md)|Encryption mode for xls files\.<br /><br /><br />**Security note:** xls encryption is provided for legacy compatibility and uses old algorithms\.<br />For new confidential files, save as xlsx and use the Agile xlsx encryption instead\.<br /><br />|
