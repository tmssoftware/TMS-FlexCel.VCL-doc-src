...
<pre><code class="lang-delphi hljs">TXmlMapMap = class(TFlexCelObject);</code></pre>
...
|[Equals](Equals.md)|Returns true if both maps have the same values\.<br />|
|[GetHashCode](GetHashCode.md)|Returns the hashcode of the map\.<br />|
