---
uid: IExcelChart.GetSeriesInSubchart
description: IExcelChart.GetSeriesInSubchart
---

# IExcelChart\.GetSeriesInSubchart Method
...
<pre><code class="lang-delphi hljs">function <a href="../IExcelChart/index.md">IExcelChart</a>.GetSeriesInSubchart(const subchart: Integer; const indexInSubchart: Integer; const getDefinitions: Boolean; const getValues: Boolean; const getOptions: Boolean): <a href="../IChartSeries/index.md">IChartSeries</a>; virtual; abstract;</code></pre>
