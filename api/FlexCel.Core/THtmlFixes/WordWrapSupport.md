---
uid: THtmlFixes.WordWrapSupport
description: THtmlFixes.WordWrapSupport
---

# THtmlFixes.WordWrapSupport Property
...
This fix is automatically applied when [Outlook2007CssSupport](Outlook2007CssSupport.md) is selected, so there is normally no reason to apply it\. You might get  a smaller file with this fix \(if you have a lot of hidden text\), but the display will not be as accurate as when it is off, so it is recommended to keep it off\.
...
<pre><code class="lang-delphi hljs">property <a href="../THtmlFixes/index.md">THtmlFixes</a>.WordWrapSupport: Boolean</code></pre>
