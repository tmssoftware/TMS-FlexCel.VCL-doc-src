...
<pre><code class="lang-delphi hljs">ARGB = record;</code></pre>
...
|[FromArgb](FromArgb.md)|**Overloaded<br />**  [FromArgb\(Integer\)](FromArgb.md#argbfromargbinteger)<br />  [FromArgb\(Integer, TUIColor\)](FromArgb.md#argbfromargbinteger-tuicolor)<br />  [FromArgb\(Integer, Integer, Integer\)](FromArgb.md#argbfromargbinteger-integer-integer)<br />  [FromArgb\(Integer, Integer, Integer, Integer\)](FromArgb.md#argbfromargbinteger-integer-integer-integer)<br />|
...
|[IsEmpty](IsEmpty.md)|Returns true if this color is the same as [TUIColor.Empty](../TUIColor/Empty.md)|
