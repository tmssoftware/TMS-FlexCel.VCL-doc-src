...
If null, then the rotation will be calculated automatically\.
...
<pre><code class="lang-delphi hljs">property <a href="../TAxisTickOptions/index.md">TAxisTickOptions</a>.Rotation: NullableInt32</code></pre>
