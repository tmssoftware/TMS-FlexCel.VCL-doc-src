---
uid: TDrawingGradientStop
description: TDrawingGradientStop
---

# TDrawingGradientStop Record

Represents one of the points in a Gradient definition for a drawing \(autoshapes, charts, etc\)\. Note that Excel cells use a different Gradient definition: [TGradientStop](../TGradientStop/index.md)

## Syntax

**Unit:** [FlexCel.Core](../index.md)

<pre><code class="lang-delphi hljs">TDrawingGradientStop = record;</code></pre>
