---
uid: IBarChartOptions
description: IBarChartOptions
---
...
<pre><code class="lang-delphi hljs">IBarChartOptions = interface(<a href="../IChartOptions/index.md">IChartOptions</a>);</code></pre>
