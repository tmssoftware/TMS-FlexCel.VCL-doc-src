...
<pre><code class="lang-delphi hljs">TUIPen = class(TFlexCelObject);</code></pre>

## Methods

|Name|Description|
|---|---|
|[CreateNew](CreateNew.md)|**Overloaded<br />**  [CreateNew\(TUIColor\)](CreateNew.md#tuipencreatenewtuicolor)<br />  [CreateNew\(TUIColor, Double\)](CreateNew.md#tuipencreatenewtuicolor-double)<br />|
