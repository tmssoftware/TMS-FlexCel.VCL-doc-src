...
<pre><code class="lang-delphi hljs">property <a href="../IGradientFill/index.md">IGradientFill</a>.Flip: <a href="../TFlipMode.md">TFlipMode</a></code></pre>
