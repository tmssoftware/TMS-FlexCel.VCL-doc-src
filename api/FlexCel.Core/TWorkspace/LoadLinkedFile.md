...
<pre><code class="lang-delphi hljs">property <a href="../TWorkspace/index.md">TWorkspace</a>.LoadLinkedFile: <a href="../TLoadLinkedFileEventHandler.md">TLoadLinkedFileEventHandler</a></code></pre>
