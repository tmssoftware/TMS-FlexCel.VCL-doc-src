...
<pre><code class="lang-delphi hljs">property <a href="../TCharAndPos/index.md">TCharAndPos</a>.Char: string</code></pre>

## See also

* [TCharAndPos](../TCharAndPos/index.md)
