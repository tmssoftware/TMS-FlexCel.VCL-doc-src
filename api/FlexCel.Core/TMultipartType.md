...
|Alternative|1|Parts inside this container are an alternative one from the other\. For example, a message could be sent in HTML and plain Text, once inside a different MIME part, and the mail reader should choose the best alternative of the parts to display\.<br />|
