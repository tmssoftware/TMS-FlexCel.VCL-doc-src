---
uid: TExcelFile.GetRadioButtonState
description: TExcelFile.GetRadioButtonState
---

# TExcelFile\.GetRadioButtonState Method
...
<pre><code class="lang-delphi hljs">function <a href="../TExcelFile/index.md">TExcelFile</a>.GetRadioButtonState(const objectIndex: Integer; const objectPath: string): Boolean; virtual; abstract;</code></pre>
...
<span class="line"><span style="color:#000000;--shiki-dark:#D4D4D4">  xls := TXlsFile.Create(</span><span style="color:#A31515;--shiki-dark:#CE9178">'radiobuttons.xls'</span><span style="color:#000000;--shiki-dark:#D4D4D4">);  </span><span style="color:#008000;--shiki-dark:#6A9955">//Open the file we want to read.</span></span>
...
<span class="line"><span style="color:#0000FF;--shiki-dark:#569CD6">      if</span><span style="color:#000000;--shiki-dark:#D4D4D4"> shp.ObjectType = TObjectType.OptionButton </span><span style="color:#0000FF;--shiki-dark:#569CD6">then</span><span style="color:#008000;--shiki-dark:#6A9955">  //Is it a radio button?</span></span>
<span class="line"><span style="color:#0000FF;--shiki-dark:#569CD6">      begin</span></span>
<span class="line"><span style="color:#000000;--shiki-dark:#D4D4D4">        LogMessage(shp.Text + </span><span style="color:#A31515;--shiki-dark:#CE9178">' :'</span><span style="color:#000000;--shiki-dark:#D4D4D4"> + BoolToStr(xls.GetRadioButtonState(i, </span><span style="color:#A31515;--shiki-dark:#CE9178">''</span><span style="color:#000000;--shiki-dark:#D4D4D4">)));  </span><span style="color:#008000;--shiki-dark:#6A9955">//Log the state of the radio button.</span></span>
