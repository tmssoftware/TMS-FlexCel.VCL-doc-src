...
<pre><code class="lang-delphi hljs">property <a href="../TExcelFile/index.md">TExcelFile</a>.VirtualCellRead: <a href="../TVirtualCellReadEventHandler.md">TVirtualCellReadEventHandler</a></code></pre>
