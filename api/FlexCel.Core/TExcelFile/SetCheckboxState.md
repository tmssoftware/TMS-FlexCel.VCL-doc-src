---
uid: TExcelFile.SetCheckboxState
description: TExcelFile.SetCheckboxState
---

# TExcelFile\.SetCheckboxState Method
...
<pre><code class="lang-delphi hljs">procedure <a href="../TExcelFile/index.md">TExcelFile</a>.SetCheckboxState(const objectIndex: Integer; const objectPath: string; const value: <a href="../TCheckboxState.md">TCheckboxState</a>); virtual; abstract;</code></pre>
...
|const|**value**|[TCheckboxState](../TCheckboxState.md)|Value to set\.|
