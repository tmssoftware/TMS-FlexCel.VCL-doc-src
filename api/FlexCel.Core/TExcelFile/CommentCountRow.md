---
uid: TExcelFile.CommentCountRow
description: TExcelFile.CommentCountRow
---

# TExcelFile\.CommentCountRow Method
...
To loop among all existing comments, you can use [CommentRowCount](CommentRowCount.md)  together with CommentCountRow\.
Do not confuse them, even when they have similar names\. [CommentRowCount](CommentRowCount.md) returns the maximum row with a comment, and CommentCountRow returns the number of comments in a given row\.
...
<pre><code class="lang-delphi hljs">function <a href="../TExcelFile/index.md">TExcelFile</a>.CommentCountRow(const row: Integer): Integer; virtual; abstract;</code></pre>
