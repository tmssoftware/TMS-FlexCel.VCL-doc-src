...
By default, even if this property is true, you will need to enter the formulas in FlexCel in A1 mode\. To change the entry mode in FlexCel, please use [FormulaReferenceStyle](FormulaReferenceStyle.md)

## Syntax

**Unit:** [FlexCel.Core](../index.md)

<pre><code class="lang-delphi hljs">property <a href="../TExcelFile/index.md">TExcelFile</a>.OptionsR1C1: Boolean</code></pre>
