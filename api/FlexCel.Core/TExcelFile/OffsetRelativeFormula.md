---
uid: TExcelFile.OffsetRelativeFormula
description: TExcelFile.OffsetRelativeFormula
---

# TExcelFile\.OffsetRelativeFormula Method
...
Remember that you can use [FormulaReferenceStyle](FormulaReferenceStyle.md) to change the formulas to R1C1 style\. R1C1 formulas are nicer for relative formulas, since they don't change when you change the cursor\. \(R1C1 references are already relative to the cell where the cursor is\)\.

## Syntax

**Unit:** [FlexCel.Core](../index.md)

<pre><code class="lang-delphi hljs">function <a href="../TExcelFile/index.md">TExcelFile</a>.OffsetRelativeFormula(const activeSheet: Integer; const cellRow: Integer; const cellCol: Integer; const expression: string): string; virtual; abstract;</code></pre>
