---
uid: TExcelFile.SetPrinterDriverSettings
description: TExcelFile.SetPrinterDriverSettings
---

# TExcelFile\.SetPrinterDriverSettings Method

Sets printer driver information\. This method is not intended to be used alone, but together with [GetPrinterDriverSettings](GetPrinterDriverSettings.md) to copy printer driver information from a file to another\.
...
<pre><code class="lang-delphi hljs">procedure <a href="../TExcelFile/index.md">TExcelFile</a>.SetPrinterDriverSettings(const settings: <a href="../TPrinterDriverSettings/index.md">TPrinterDriverSettings</a>); virtual; abstract;</code></pre>

## Parameters

|<->|Parameter|Type|Description|
|---|---|---|---|
|const|**settings**|[TPrinterDriver&#8203;Settings](../TPrinterDriverSettings/index.md)|Printer driver information obtained with [GetPrinterDriverSettings](GetPrinterDriverSettings.md)\. Use null to remove the printer settings\.|
