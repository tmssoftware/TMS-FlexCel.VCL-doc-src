---
uid: TExcelFile.ColToIndex
description: TExcelFile.ColToIndex
---

# TExcelFile\.ColToIndex Method

## Overloads

* [TExcelFile\.ColToIndex\(Integer, Integer\)](#texcelfilecoltoindexinteger-integer)
* [TExcelFile\.ColToIndex\(Integer, Integer, Integer\)](#texcelfilecoltoindexinteger-integer-integer)

# TExcelFile\.ColToIndex\(Integer, Integer\)
This is the inverse of [ColFromIndex\(Integer, Integer\)](ColFromIndex.md#texcelfilecolfromindexinteger-integer)\. It will return the index on the  internal column array from the row for an existing column\. If the column doesn't exist, it will return the  index of the "LAST existing column less than col", plus 1\.
You can use this together with [ColCountInRow\(Integer\)](ColCountInRow.md#texcelfilecolcountinrowinteger) and [ColFromIndex\(Integer, Integer\)](ColFromIndex.md#texcelfilecolfromindexinteger-integer) to iterate faster on a block\.
...
<pre><code class="lang-delphi hljs">function <a href="../TExcelFile/index.md">TExcelFile</a>.ColToIndex(const row: Integer; const col: Integer): Integer; overload; virtual; abstract;</code></pre>
...
# TExcelFile\.ColToIndex\(Integer, Integer, Integer\)
This is the inverse of [ColFromIndex\(Integer, Integer\)](ColFromIndex.md#texcelfilecolfromindexinteger-integer)\. It will return the index on the  internal column array from the row for an existing column\. If the column doesn't exist, it will return the  index of the "LAST existing column less than col", plus 1\.
You can use this together with [ColCountInRow\(Integer\)](ColCountInRow.md#texcelfilecolcountinrowinteger) and [ColFromIndex\(Integer, Integer\)](ColFromIndex.md#texcelfilecolfromindexinteger-integer) to iterate faster on a block\.
Or you can call [LoopOverUsedRange](LoopOverUsedRange.md) for a method that does the looping for you using those methods\.
...
<pre><code class="lang-delphi hljs">function <a href="../TExcelFile/index.md">TExcelFile</a>.ColToIndex(const sheet: Integer; const row: Integer; const col: Integer): Integer; overload; virtual; abstract;</code></pre>
