---
uid: TExcelFile.SetCellFormat
description: TExcelFile.SetCellFormat
---
...
* [TExcelFile\.SetCellFormat\(Integer, Integer, Integer\)](#texcelfilesetcellformatinteger-integer-integer)
* [TExcelFile\.SetCellFormat\(Integer, Integer, Integer, Integer, Integer\)](#texcelfilesetcellformatinteger-integer-integer-integer-integer)
* [TExcelFile\.SetCellFormat\(Integer, Integer, Integer, Integer, TFlxFormat, TFlxApplyFormat\)](#texcelfilesetcellformatinteger-integer-integer-integer-tflxformat-tflxapplyformat)
* [TExcelFile\.SetCellFormat\(Integer, Integer, Integer, Integer, TFlxFormat, TFlxApplyFormat, Boolean\)](#texcelfilesetcellformatinteger-integer-integer-integer-tflxformat-tflxapplyformat-boolean)
...
<pre><code class="lang-delphi hljs">procedure <a href="../TExcelFile/index.md">TExcelFile</a>.SetCellFormat(const row: Integer; const col: Integer; const XF: Integer); overload; virtual; abstract;</code></pre>
...
<pre><code class="lang-delphi hljs">procedure <a href="../TExcelFile/index.md">TExcelFile</a>.SetCellFormat(const row1: Integer; const col1: Integer; const row2: Integer; const col2: Integer; const XF: Integer); overload; virtual; abstract;</code></pre>
...
<pre><code class="lang-delphi hljs">procedure <a href="../TExcelFile/index.md">TExcelFile</a>.SetCellFormat(const row1: Integer; const col1: Integer; const row2: Integer; const col2: Integer; const newFormat: <a href="../TFlxFormat/index.md">TFlxFormat</a>; const applyNewFormat: <a href="../TFlxApplyFormat/index.md">TFlxApplyFormat</a>); overload;</code></pre>
...
|const|**row2**|Integer|Row index of the bottom cell on the range \(1 based\)|
|const|**col2**|Integer|Column index of the right cell on the range \(1 based\)|
|const|**newFormat**|[TFlxFormat](../TFlxFormat/index.md)|Format to apply to the cells\.|
...
<pre><code class="lang-delphi hljs">procedure <a href="../TExcelFile/index.md">TExcelFile</a>.SetCellFormat(const row1: Integer; const col1: Integer; const row2: Integer; const col2: Integer; const newFormat: <a href="../TFlxFormat/index.md">TFlxFormat</a>; const applyNewFormat: <a href="../TFlxApplyFormat/index.md">TFlxApplyFormat</a>; const exteriorBorders: Boolean); overload; virtual; abstract;</code></pre>
