...
* [TExcelFile\.Sort\(TXlsCellRange, Boolean, Int32Array, TSortOrderArray, TComparer\<TCellValue>\)](#texcelfilesorttxlscellrange-boolean-int32array-tsortorderarray-tcomparertcellvalue)
* [TExcelFile\.Sort\(TXlsCellRange, Boolean, Int32Array, TSortOrderArray, TComparer\<TCellValue>, TSortFormulaMode\)](#texcelfilesorttxlscellrange-boolean-int32array-tsortorderarray-tcomparertcellvalue-tsortformulamode)
...
<pre><code class="lang-delphi hljs">procedure <a href="../TExcelFile/index.md">TExcelFile</a>.Sort(const Range: <a href="../TXlsCellRange/index.md">TXlsCellRange</a>; const ByRows: Boolean; const Keys: TArray&lt;Int32>; const SortOrder: <a href="../TSortOrder.md">TArray&lt;TSortOrder></a>; const Comparer: TComparer&lt;<a href="../TCellValue/index.md">TCellValue</a>&gt;); overload;</code></pre>

## Parameters

|<->|Parameter|Type|Description|
|---|---|---|---|
|const|**Range**|[TXlsCellRange](../TXlsCellRange/index.md)|Range to sort\. It must not include headers\.|
...
|const|**SortOrder**|[TArray\<TSortOrder>](../TSortOrder.md)|An array of flags indicating whether to sort ascending or descending for each Key\. If null, all sorts will be ascending\. If not null and the array size is less than the size of the "Keys" parameter, all missing entries are assumed to be Ascending\.|
|const|**Comparer**|TComparer\<[TCellValue](../TCellValue/index.md)>|Comparer to create a custom way to compare the different items\. Set it to null to use default ordering\.|
...
<span class="line"><span style="color:#0000FF;--shiki-dark:#569CD6">    nil</span><span style="color:#008000;--shiki-dark:#6A9955"> // Use the standard comparer.</span></span>
...
<pre><code class="lang-delphi hljs">procedure <a href="../TExcelFile/index.md">TExcelFile</a>.Sort(const Range: <a href="../TXlsCellRange/index.md">TXlsCellRange</a>; const ByRows: Boolean; const Keys: TArray&lt;Int32>; const SortOrder: <a href="../TSortOrder.md">TArray&lt;TSortOrder></a>; const Comparer: TComparer&lt;<a href="../TCellValue/index.md">TCellValue</a>&gt;; const SortFormulaMode: <a href="../TSortFormulaMode.md">TSortFormulaMode</a>); overload; virtual; abstract;</code></pre>
...
|const|**SortOrder**|[TArray\<TSortOrder>](../TSortOrder.md)|An array of flags indicating whether to sort ascending or descending for each Key\. If null, all sorts will be ascending\. If not null and the array size is less than the size of the "Keys" parameter, all missing entries are assumed to be Ascending\.|
|const|**Comparer**|TComparer\<[TCellValue](../TCellValue/index.md)>|Comparer to create a custom way to compare the different items\. Set it to null to use default ordering\.|
|const|**SortFormulaMode**|[TSortFormulaMode](../TSortFormulaMode.md)|Defines how formulas in the file will be changed when sorting\.|


## Examples

To sort the range of cells from B7 to D100, on columns B Ascending and C Descending using [TSortFormulaMode.ExcelLike](../TSortFormulaMode.md):
