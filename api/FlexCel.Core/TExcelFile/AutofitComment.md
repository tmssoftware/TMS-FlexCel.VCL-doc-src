---
uid: TExcelFile.AutofitComment
description: TExcelFile.AutofitComment
---

# TExcelFile\.AutofitComment Method
...
<pre><code class="lang-delphi hljs">function <a href="../TExcelFile/index.md">TExcelFile</a>.AutofitComment(const text: <a href="../TRichString/index.md">TRichString</a>; const aspectRatio: Double; const dontShrink: Boolean; const adjustment: Double; const adjustmentFixed: Double; const Anchor: <a href="../TClientAnchor/index.md">TClientAnchor</a>): <a href="../TClientAnchor/index.md">TClientAnchor</a>; virtual; abstract;</code></pre>

## Parameters

|<->|Parameter|Type|Description|
|---|---|---|---|
|const|**text**|[TRichString](../TRichString/index.md)|Text for the comment\.|
...
|const|**Anchor**|[TClientAnchor](../TClientAnchor/index.md)|Here you pass the original dimensions for the comment\.|
