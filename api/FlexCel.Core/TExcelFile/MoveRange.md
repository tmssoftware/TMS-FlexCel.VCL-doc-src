---
uid: TExcelFile.MoveRange
description: TExcelFile.MoveRange
---

# TExcelFile\.MoveRange Method

## Overloads

* [TExcelFile\.MoveRange\(TXlsCellRange, Integer, Integer, TFlxInsertMode\)](#texcelfilemoverangetxlscellrange-integer-integer-tflxinsertmode)
* [TExcelFile\.MoveRange\(TXlsCellRange, Integer, Integer, TFlxInsertMode, Boolean\)](#texcelfilemoverangetxlscellrange-integer-integer-tflxinsertmode-boolean)

# TExcelFile\.MoveRange\(TXlsCellRange, Integer, Integer, TFlxInsertMode\)
...
# TExcelFile\.MoveRange\(TXlsCellRange, Integer, Integer, TFlxInsertMode, Boolean\)
Moves a range of cells, the same way Excel does it\. All references pointing to the old range will be relocated to the new, and all existing references to the new range will be relocated to \#ref\.
...
<pre><code class="lang-delphi hljs">procedure <a href="../TExcelFile/index.md">TExcelFile</a>.MoveRange(const cellRange: <a href="../TXlsCellRange/index.md">TXlsCellRange</a>; const newRow: Integer; const newCol: Integer; const insertMode: <a href="../TFlxInsertMode.md">TFlxInsertMode</a>; const fixAllFormulas: Boolean); overload; virtual; abstract;</code></pre>
