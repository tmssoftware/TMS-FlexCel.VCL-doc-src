---
uid: TExcelFile.HeightCorrection
...
You can use this property and [WidthCorrection](WidthCorrection.md) to manually fine tune FlexCel printing, previewing and exporting to PDF to make it smaller or larger\. A normal value for this property might be 1\.05 or 0\.99, but don't use it unless you really need to\.
...
<pre><code class="lang-delphi hljs">property <a href="../TExcelFile/index.md">TExcelFile</a>.HeightCorrection: Double</code></pre>
