---
uid: TExcelFile.SetCellFromHtml
description: TExcelFile.SetCellFromHtml
---

# TExcelFile\.SetCellFromHtml Method

## Overloads

* [TExcelFile\.SetCellFromHtml\(Integer, Integer, string\)](#texcelfilesetcellfromhtmlinteger-integer-string)
* [TExcelFile\.SetCellFromHtml\(Integer, Integer, string, Integer\)](#texcelfilesetcellfromhtmlinteger-integer-string-integer)

# TExcelFile\.SetCellFromHtml\(Integer, Integer, string\)
...
<pre><code class="lang-delphi hljs">procedure <a href="../TExcelFile/index.md">TExcelFile</a>.SetCellFromHtml(const row: Integer; const col: Integer; const htmlText: string); overload;</code></pre>
...
# TExcelFile\.SetCellFromHtml\(Integer, Integer, string, Integer\)
Enters an HTML formatted string into a cell, and tries to match the Excel formats with the HTML formatting tags\.
Note that the rich text inside Excel is more limited than xls \(you are limited to only changing font attributes\), so many tags from the HTML tags might be ignored\. Whenever a tag is not understood or cannot be mapped into Excel, it will just be omitted\. For a list of supported tags, see the **Remarks** section\.
...
<pre><code class="lang-delphi hljs">procedure <a href="../TExcelFile/index.md">TExcelFile</a>.SetCellFromHtml(const row: Integer; const col: Integer; const htmlText: string; const XF: Integer); overload; virtual; abstract;</code></pre>
