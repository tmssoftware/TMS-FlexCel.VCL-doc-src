...
<pre><code class="lang-delphi hljs">property <a href="../TExcelFile/index.md">TExcelFile</a>.VirtualMode: Boolean</code></pre>

## Examples

You can find a full example of Virtual mode in the sample: 10\.API\\22\.Virtual Mode
But here we will show a simpler example which reads only the first row of cells from the first sheet and then exits\.
