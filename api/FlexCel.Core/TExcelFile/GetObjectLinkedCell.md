---
uid: TExcelFile.GetObjectLinkedCell
description: TExcelFile.GetObjectLinkedCell
---

# TExcelFile\.GetObjectLinkedCell Method
...
Also note that this applies to form objects\. To get the link of a shape like a circle or rectangle, use [GetShapeLinkedCell](GetShapeLinkedCell.md) instead\.
...
<pre><code class="lang-delphi hljs">function <a href="../TExcelFile/index.md">TExcelFile</a>.GetObjectLinkedCell(const objectIndex: Integer; const objectPath: string): <a href="../TCellAddress/index.md">TCellAddress</a>; virtual; abstract;</code></pre>
