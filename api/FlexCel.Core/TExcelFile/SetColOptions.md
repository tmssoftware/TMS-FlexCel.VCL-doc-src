---
uid: TExcelFile.SetColOptions
description: TExcelFile.SetColOptions
---

# TExcelFile\.SetColOptions Method
...
To set individual values, use the corresponding methods \(i\.e\. [SetColHidden\(Integer, Integer, Boolean\)](SetColHidden.md#texcelfilesetcolhiddeninteger-integer-boolean)\) Use this method only to copy the options from one column to another\.
...
<pre><code class="lang-delphi hljs">procedure <a href="../TExcelFile/index.md">TExcelFile</a>.SetColOptions(const col: Integer; const options: Integer); virtual; abstract;</code></pre>
