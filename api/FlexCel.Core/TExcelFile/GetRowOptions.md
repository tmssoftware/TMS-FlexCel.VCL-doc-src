---
uid: TExcelFile.GetRowOptions
description: TExcelFile.GetRowOptions
---
...
To get individual values, use the corresponding methods \(i\.e\. [GetAutoRowHeight](GetAutoRowHeight.md)\) Use this method only to copy the options from one row to another\.
...
<pre><code class="lang-delphi hljs">function <a href="../TExcelFile/index.md">TExcelFile</a>.GetRowOptions(const row: Integer): Integer; virtual; abstract;</code></pre>
