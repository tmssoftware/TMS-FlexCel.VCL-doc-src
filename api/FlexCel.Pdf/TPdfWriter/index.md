...
|[PdfSubType](PdfSubType.md)|Used with specific values of [PdfType](PdfType.md), when the subtype cannot be deduced automatically\.<br />You will normally want to leave this property at [TPdfSubType.Default](../TPdfSubType.md)\. Only change it if you are required to create a specific subtype of PDF, which is not what is automatically deduced\.<br />|
