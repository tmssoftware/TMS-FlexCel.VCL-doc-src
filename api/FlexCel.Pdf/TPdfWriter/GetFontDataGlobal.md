...
<pre><code class="lang-delphi hljs">property <a href="../TPdfWriter/index.md">TPdfWriter</a>.GetFontDataGlobal: <a href="../TGetFontDataEventHandler.md">TGetFontDataEventHandler</a></code></pre>
