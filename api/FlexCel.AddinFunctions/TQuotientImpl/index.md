...
<pre><code class="lang-delphi hljs">TQuotientImpl = class(<a href="../../FlexCel.Core/TUserDefinedFunction/index.md">TUserDefinedFunction</a>);</code></pre>
