---
uid: TXlsBaseChart.GetImageAlternate
description: TXlsBaseChart.GetImageAlternate
---

# TXlsBaseChart\.GetImageAlternate Method
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsBaseChart/index.md">TXlsBaseChart</a>.GetImageAlternate(const imageIndex: Integer; const objectPath: string; out imageType: <a href="../../FlexCel.Core/TXlsImgType.md">TXlsImgType</a>; const outStream: TStream; const usesObjectIndex: Boolean); virtual; abstract;</code></pre>
