---
uid: TXlsBaseChart.GetImage
description: TXlsBaseChart.GetImage
---
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsBaseChart/index.md">TXlsBaseChart</a>.GetImage(const imageIndex: Integer; const objectPath: string; var imageType: <a href="../../FlexCel.Core/TXlsImgType.md">TXlsImgType</a>; const outStream: TStream; const usesObjectIndex: Boolean); virtual; abstract;</code></pre>
