---
uid: TXlsFile.GetCheckboxState
description: TXlsFile.GetCheckboxState
---
...
<pre><code class="lang-delphi hljs">function <a href="../TXlsFile/index.md">TXlsFile</a>.GetCheckboxState(const objectIndex: Integer; const objectPath: string): <a href="../../FlexCel.Core/TCheckboxState.md">TCheckboxState</a>; override;</code></pre>
