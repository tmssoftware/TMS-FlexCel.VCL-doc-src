---
uid: TXlsFile.GetRadioButtonState
description: TXlsFile.GetRadioButtonState
---
...
<pre><code class="lang-delphi hljs">function <a href="../TXlsFile/index.md">TXlsFile</a>.GetRadioButtonState(const objectIndex: Integer; const objectPath: string): Boolean; override;</code></pre>
