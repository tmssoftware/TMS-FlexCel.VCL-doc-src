---
uid: TXlsFile.DeleteObject
description: TXlsFile.DeleteObject
---

# TXlsFile\.DeleteObject Method
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsFile/index.md">TXlsFile</a>.DeleteObject(const objectIndex: Integer; const objectPath: string); overload; override;</code></pre>
