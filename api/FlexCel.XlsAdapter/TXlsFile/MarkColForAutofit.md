...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsFile/index.md">TXlsFile</a>.MarkColForAutofit(const col: Integer; const autofit: Boolean; const adjustment: Double; const adjustmentFixed: Integer; const minWidth: Integer; const maxWidth: Integer; const isMerged: Boolean); overload; override;</code></pre>
