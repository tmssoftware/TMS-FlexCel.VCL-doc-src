...
<pre><code class="lang-delphi hljs">property <a href="../TXlsFile/index.md">TXlsFile</a>.RecalcVersion: <a href="../../FlexCel.Core/TRecalcVersion.md">TRecalcVersion</a></code></pre>
