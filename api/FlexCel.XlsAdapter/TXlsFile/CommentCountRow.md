---
uid: TXlsFile.CommentCountRow
description: TXlsFile.CommentCountRow
---

# TXlsFile\.CommentCountRow Method
...
To loop among all existing comments, you can use [TExcelFile.CommentRowCount](../../FlexCel.Core/TExcelFile/CommentRowCount.md)  together with CommentCountRow\.
Do not confuse them, even when they have similar names\. [TExcelFile.CommentRowCount](../../FlexCel.Core/TExcelFile/CommentRowCount.md) returns the maximum row with a comment, and CommentCountRow returns the number of comments in a given row\.
...
<pre><code class="lang-delphi hljs">function <a href="../TXlsFile/index.md">TXlsFile</a>.CommentCountRow(const row: Integer): Integer; override;</code></pre>
