---
uid: TXlsFile.SetNamedRange
description: TXlsFile.SetNamedRange
---
...
* [TXlsFile\.SetNamedRange\(TXlsNamedRange\)](#txlsfilesetnamedrangetxlsnamedrange)
* [TXlsFile\.SetNamedRange\(Integer, TXlsNamedRange\)](#txlsfilesetnamedrangeinteger-txlsnamedrange)
...
If the range is not user defined \(like "Print\_Area"\) it will have a one\-char name, and the value is on the enum [TInternalNameRange](../../FlexCel.Core/TInternalNameRange.md) Look at the example for more information\.
...
<pre><code class="lang-delphi hljs">function <a href="../TXlsFile/index.md">TXlsFile</a>.SetNamedRange(const rangeData: <a href="../../FlexCel.Core/TXlsNamedRange/index.md">TXlsNamedRange</a>): Integer; overload; override;</code></pre>

## Parameters

|<->|Parameter|Type|Description|
|---|---|---|---|
|const|**rangeData**|[TXlsNamedRange](../../FlexCel.Core/TXlsNamedRange/index.md)|Data of the named range\. You don't need to specify the RPN Array\.|
...
Modifies a Named Range in the specified position\. You could normally use [TExcelFile.SetNamedRange\(TXlsNamedRange\)](../../FlexCel.Core/TExcelFile/SetNamedRange.md#texcelfilesetnamedrangetxlsnamedrange) to do this, but if you want to modify the name of the named range, then you need to use this overloaded version\. [TExcelFile.SetNamedRange\(TXlsNamedRange\)](../../FlexCel.Core/TExcelFile/SetNamedRange.md#texcelfilesetnamedrangetxlsnamedrange) would add a new range instead of modifying the existing one if you change the name\.
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsFile/index.md">TXlsFile</a>.SetNamedRange(const index: Integer; const rangeData: <a href="../../FlexCel.Core/TXlsNamedRange/index.md">TXlsNamedRange</a>); overload; override;</code></pre>
