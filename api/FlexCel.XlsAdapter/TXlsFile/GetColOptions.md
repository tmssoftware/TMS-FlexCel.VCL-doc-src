---
uid: TXlsFile.GetColOptions
description: TXlsFile.GetColOptions
---

# TXlsFile\.GetColOptions Method
...
To get individual values, use the corresponding methods \(i\.e\. [TExcelFile.GetColHidden](../../FlexCel.Core/TExcelFile/GetColHidden.md)\) Use this method only to copy the options from one column to another\.
...
<pre><code class="lang-delphi hljs">function <a href="../TXlsFile/index.md">TXlsFile</a>.GetColOptions(const col: Integer): Integer; override;</code></pre>
