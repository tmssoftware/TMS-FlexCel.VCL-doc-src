---
uid: TXlsFile.SaveForHashing
description: TXlsFile.SaveForHashing
---

# TXlsFile\.SaveForHashing Method
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsFile/index.md">TXlsFile</a>.SaveForHashing(const aStream: TStream; const excludedRecords: <a href="../../FlexCel.Core/TExcludedRecords.md">Set of TExcludedRecords</a>); overload; override;</code></pre>
