---
uid: TXlsFile.GetShapeLinkedCell
description: TXlsFile.GetShapeLinkedCell
---

# TXlsFile\.GetShapeLinkedCell Method
...
Also note that this method applies to shapes like a rectangle or circle, or an image\. To get the link of a forms object like a combobox or a radiobutton use [TExcelFile.GetObjectLinkedCell](../../FlexCel.Core/TExcelFile/GetObjectLinkedCell.md) instead\.
...
<pre><code class="lang-delphi hljs">function <a href="../TXlsFile/index.md">TXlsFile</a>.GetShapeLinkedCell(const objectIndex: Integer; const objectPath: string): string; override;</code></pre>
