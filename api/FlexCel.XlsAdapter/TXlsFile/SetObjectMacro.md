---
uid: TXlsFile.SetObjectMacro
description: TXlsFile.SetObjectMacro
---

# TXlsFile\.SetObjectMacro Method
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsFile/index.md">TXlsFile</a>.SetObjectMacro(const objectIndex: Integer; const objectPath: string; const macro: string); override;</code></pre>
