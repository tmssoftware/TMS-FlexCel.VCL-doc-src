---
uid: TXlsFile.SetRadioButtonState
description: TXlsFile.SetRadioButtonState
---
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsFile/index.md">TXlsFile</a>.SetRadioButtonState(const objectIndex: Integer; const objectPath: string; const selected: Boolean); override;</code></pre>
