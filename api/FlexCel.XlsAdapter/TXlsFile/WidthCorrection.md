---
uid: TXlsFile.WidthCorrection
description: TXlsFile.WidthCorrection
---

# TXlsFile.WidthCorrection Property
...
You can use this property and [TExcelFile.HeightCorrection](../../FlexCel.Core/TExcelFile/HeightCorrection.md) to manually fine tune FlexCel printing, previewing and exporting to PDF to make it smaller or larger\. A normal value for this property might be 1\.05 or 0\.99, but don't use it unless you really need to\.
...
<pre><code class="lang-delphi hljs">property <a href="../TXlsFile/index.md">TXlsFile</a>.WidthCorrection: Double</code></pre>
