---
uid: TXlsFile.RecalcRange
description: TXlsFile.RecalcRange
---

# TXlsFile\.RecalcRange Method
...
<pre><code class="lang-delphi hljs">function <a href="../TXlsFile/index.md">TXlsFile</a>.RecalcRange(const activeSheet: Integer; const activeRow: Integer; const activeCol: Integer; const rowOffset: Integer; const colOffset: Integer; const expression: string; const forced: Boolean; const relativeReferences: Boolean): TArray&lt;<a href="../../FlexCel.Core/TCellAddressRange/index.md">TCellAddressRange</a>&gt;; override;</code></pre>
