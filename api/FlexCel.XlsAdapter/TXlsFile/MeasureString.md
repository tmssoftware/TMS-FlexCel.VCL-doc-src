---
uid: TXlsFile.MeasureString
description: TXlsFile.MeasureString
---

# TXlsFile\.MeasureString Method
...
<pre><code class="lang-delphi hljs">function <a href="../TXlsFile/index.md">TXlsFile</a>.MeasureString(const text: <a href="../../FlexCel.Core/TRichString/index.md">TRichString</a>; const cellFont: <a href="../../FlexCel.Core/TFlxFont/index.md">TFlxFont</a>): <a href="../../FlexCel.Core/TUISize/index.md">TUISize</a>; override;</code></pre>

## Parameters

|<->|Parameter|Type|Description|
|---|---|---|---|
|const|**text**|[TRichString](../../FlexCel.Core/TRichString/index.md)|Rich string to measure\.|
|const|**cellFont**|[TFlxFont](../../FlexCel.Core/TFlxFont/index.md)|Font of the cell itself\. This font might change later in the string\.|
