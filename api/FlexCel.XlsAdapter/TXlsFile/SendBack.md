---
uid: TXlsFile.SendBack
description: TXlsFile.SendBack
---
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsFile/index.md">TXlsFile</a>.SendBack(const objectIndex: Integer); override;</code></pre>
