---
uid: TXlsFile.SetRowOptions
description: TXlsFile.SetRowOptions
---
...
To set individual values, use the corresponding methods \(i\.e\. [TExcelFile.SetAutoRowHeight](../../FlexCel.Core/TExcelFile/SetAutoRowHeight.md)\) Use this method only to copy the options from one row to another\.
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsFile/index.md">TXlsFile</a>.SetRowOptions(const row: Integer; const options: Integer); override;</code></pre>
