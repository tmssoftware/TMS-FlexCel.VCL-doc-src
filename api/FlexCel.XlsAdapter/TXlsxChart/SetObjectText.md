---
uid: TXlsxChart.SetObjectText
description: TXlsxChart.SetObjectText
---
...
* [TXlsxChart\.SetObjectText\(Integer, string, string\)](#txlsxchartsetobjecttextinteger-string-string)
* [TXlsxChart\.SetObjectText\(Integer, string, TRichString\)](#txlsxchartsetobjecttextinteger-string-trichstring)
* [TXlsxChart\.SetObjectText\(Integer, string, TDrawingRichString\)](#txlsxchartsetobjecttextinteger-string-tdrawingrichstring)
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsxChart/index.md">TXlsxChart</a>.SetObjectText(const objectIndex: Integer; const objectPath: string; const text: string); overload; override;</code></pre>
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsxChart/index.md">TXlsxChart</a>.SetObjectText(const objectIndex: Integer; const objectPath: string; const text: <a href="../../FlexCel.Core/TRichString/index.md">TRichString</a>); overload; override;</code></pre>
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsxChart/index.md">TXlsxChart</a>.SetObjectText(const objectIndex: Integer; const objectPath: string; const text: <a href="../../FlexCel.Core/TDrawingRichString/index.md">TDrawingRichString</a>); overload; override;</code></pre>
