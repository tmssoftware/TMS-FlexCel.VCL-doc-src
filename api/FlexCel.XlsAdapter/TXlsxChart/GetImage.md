---
uid: TXlsxChart.GetImage
description: TXlsxChart.GetImage
---

# TXlsxChart\.GetImage Method
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsxChart/index.md">TXlsxChart</a>.GetImage(const imageIndex: Integer; const objectPath: string; var imageType: <a href="../../FlexCel.Core/TXlsImgType.md">TXlsImgType</a>; const outStream: TStream; const usesObjectIndex: Boolean); override;</code></pre>
