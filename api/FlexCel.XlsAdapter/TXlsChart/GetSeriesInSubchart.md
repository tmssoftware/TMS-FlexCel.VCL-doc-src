---
uid: TXlsChart.GetSeriesInSubchart
description: TXlsChart.GetSeriesInSubchart
---

# TXlsChart\.GetSeriesInSubchart Method
...
<pre><code class="lang-delphi hljs">function <a href="../TXlsChart/index.md">TXlsChart</a>.GetSeriesInSubchart(const subchart: Integer; const indexInSubchart: Integer; const getDefinitions: Boolean; const getValues: Boolean; const getOptions: Boolean): <a href="../../FlexCel.Core/IChartSeries/index.md">IChartSeries</a>;</code></pre>
