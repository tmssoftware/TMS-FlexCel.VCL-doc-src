...
<pre><code class="lang-delphi hljs">TXlsChart = class(<a href="../TXlsBaseChart/index.md">TXlsBaseChart</a>, <a href="../../FlexCel.Core/IExcelChart/index.md">IExcelChart</a>);</code></pre>
...
|[SetObjectText](SetObjectText.md)|**Overloaded<br />**  [SetObjectText\(Integer, string, string\)](SetObjectText.md#txlschartsetobjecttextinteger-string-string)<br />  [SetObjectText\(Integer, string, TRichString\)](SetObjectText.md#txlschartsetobjecttextinteger-string-trichstring)<br />  [SetObjectText\(Integer, string, TDrawingRichString\)](SetObjectText.md#txlschartsetobjecttextinteger-string-tdrawingrichstring)<br />|
|[DeleteObject](DeleteObject.md)|**Overloaded<br />**  [DeleteObject\(Integer\)](DeleteObject.md#txlschartdeleteobjectinteger)<br />  [DeleteObject\(Integer, string\)](DeleteObject.md#txlschartdeleteobjectinteger-string)<br />|
