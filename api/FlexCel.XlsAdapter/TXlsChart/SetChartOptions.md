---
uid: TXlsChart.SetChartOptions
description: TXlsChart.SetChartOptions
---

# TXlsChart\.SetChartOptions Method
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsChart/index.md">TXlsChart</a>.SetChartOptions(const subchartPos: Integer; options: <a href="../../FlexCel.Core/IChartOptions/index.md">IChartOptions</a>);</code></pre>
