---
uid: TXlsChart.GetImage
description: TXlsChart.GetImage
---

# TXlsChart\.GetImage Method
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsChart/index.md">TXlsChart</a>.GetImage(const imageIndex: Integer; const objectPath: string; var imageType: <a href="../../FlexCel.Core/TXlsImgType.md">TXlsImgType</a>; const outStream: TStream; const usesObjectIndex: Boolean); override;</code></pre>
