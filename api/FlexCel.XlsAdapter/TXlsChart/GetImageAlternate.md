---
uid: TXlsChart.GetImageAlternate
description: TXlsChart.GetImageAlternate
---

# TXlsChart\.GetImageAlternate Method
...
<pre><code class="lang-delphi hljs">procedure <a href="../TXlsChart/index.md">TXlsChart</a>.GetImageAlternate(const imageIndex: Integer; const objectPath: string; out imageType: <a href="../../FlexCel.Core/TXlsImgType.md">TXlsImgType</a>; const outStream: TStream; const usesObjectIndex: Boolean); override;</code></pre>
