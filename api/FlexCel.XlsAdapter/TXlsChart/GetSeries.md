---
uid: TXlsChart.GetSeries
description: TXlsChart.GetSeries
---
...
<pre><code class="lang-delphi hljs">function <a href="../TXlsChart/index.md">TXlsChart</a>.GetSeries(const index: Integer; const getDefinitions: Boolean; const getValues: Boolean; const getOptions: Boolean): <a href="../../FlexCel.Core/IChartSeries/index.md">IChartSeries</a>;</code></pre>
