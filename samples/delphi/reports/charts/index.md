...
> [!Note]
> This demo is available in your FlexCel installation at ***&lt;FlexCel Install Folder>*\\Demo\\Delphi\\Modules\\20\.Reports\\70\.Charts** and also at [https:&#8203;//&#8203;github.&#8203;com/&#8203;tmssoftware/&#8203;TMS-&#8203;FlexCel.&#8203;VCL-&#8203;demos/&#8203;tree/&#8203;master/&#8203;Delphi/&#8203;Modules/&#8203;20.&#8203;Reports/&#8203;70.&#8203;Charts](https://github\.com/tmssoftware/TMS\-FlexCel\.VCL\-demos/tree/master/Delphi/Modules/20\.Reports/70\.Charts)
...
- Charts might be difficult: Sometimes Excel goes out of its way
  ...
  you use [x-ranges](~/guides/reports-designer-guide.md#x-ranges), it will be deleted.

- You can't use a  \<\#[delete row](~/guides/reports-tag-reference.md#delete-row)\> tag to remove the extra row. \<\#[delete row](~/guides/reports-tag-reference.md#delete-row)\> tags are
  ...
  now have [x-ranges](~/guides/reports-designer-guide.md#x-ranges). If you put \"X\" as the last char on a
...
- Usually when you create a chart, series remain fixed and the data
  ...
  and new series are created. For those cases, you can use [swap series](~/guides/reports-tag-reference.md#swap-series)\> tags. Look at the example [Charts With Dynamic Series](~/samples/delphi/reports/charts-with-dynamic-series/index.md) 
...
<span class="line"><span style="color:#000000;--shiki-dark:#D4D4D4">      TPath.Combine(GetDataPath, </span><span style="color:#A31515;--shiki-dark:#CE9178">'Charts.template.xls'</span><span style="color:#000000;--shiki-dark:#D4D4D4">),</span></span>
